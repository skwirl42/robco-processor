...
opcode_entry_t opcode_entries[] =
{
    ...
    // Flow instructions
    { "b",      OPCODE_B,                       1, SYMBOL_ADDRESS_INST, IMMEDIATE_OPERANDS,     SIGNEDNESS_SIGNED },
    { "beq",    OPCODE_BEQ,                     1, SYMBOL_ADDRESS_INST, IMMEDIATE_OPERANDS,     SIGNEDNESS_SIGNED },
    { "blt",    OPCODE_BLT,                     1, SYMBOL_ADDRESS_INST, IMMEDIATE_OPERANDS,     SIGNEDNESS_SIGNED },
    { "ble",    OPCODE_BLE,                     1, SYMBOL_ADDRESS_INST, IMMEDIATE_OPERANDS,     SIGNEDNESS_SIGNED },
    { "bcr",    OPCODE_BCR,                     1, SYMBOL_ADDRESS_INST, IMMEDIATE_OPERANDS,     SIGNEDNESS_SIGNED },
    { "bov",    OPCODE_BOV,                     1, SYMBOL_ADDRESS_INST, IMMEDIATE_OPERANDS,     SIGNEDNESS_SIGNED },
    { "bdiv0",  OPCODE_BDIV0,                   1, SYMBOL_ADDRESS_INST, IMMEDIATE_OPERANDS,     SIGNEDNESS_SIGNED },
